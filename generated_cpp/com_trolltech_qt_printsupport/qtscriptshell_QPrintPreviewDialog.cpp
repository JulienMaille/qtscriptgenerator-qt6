...
void QtScriptShell_QPrintPreviewDialog::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewDialog::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
