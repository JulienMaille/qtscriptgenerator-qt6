...
void QtScriptShell_QAbstractPrintDialog::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractPrintDialog::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
