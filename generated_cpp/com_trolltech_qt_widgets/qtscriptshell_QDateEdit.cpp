...
void QtScriptShell_QDateEdit::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QDateEdit::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
