...
void QtScriptShell_QProgressBar::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QProgressBar::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
