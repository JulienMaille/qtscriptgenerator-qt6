...
void QtScriptShell_QPlainTextEdit::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QPlainTextEdit::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
