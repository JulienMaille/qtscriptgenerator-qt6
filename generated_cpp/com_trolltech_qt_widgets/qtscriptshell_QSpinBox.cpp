...
void QtScriptShell_QSpinBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QSpinBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
