...
void QtScriptShell_QToolBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QToolBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
