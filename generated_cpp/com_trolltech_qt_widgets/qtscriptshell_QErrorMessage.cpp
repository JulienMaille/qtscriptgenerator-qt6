...
void QtScriptShell_QErrorMessage::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QErrorMessage::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
