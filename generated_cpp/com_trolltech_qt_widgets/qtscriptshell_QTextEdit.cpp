...
void QtScriptShell_QTextEdit::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTextEdit::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
