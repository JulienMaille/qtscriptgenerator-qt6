...
void QtScriptShell_QCommandLinkButton::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QCommandLinkButton::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
