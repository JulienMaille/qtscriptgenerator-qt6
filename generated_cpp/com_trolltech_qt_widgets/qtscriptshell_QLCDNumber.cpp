...
void QtScriptShell_QLCDNumber::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QLCDNumber::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
