...
void QtScriptShell_QProgressDialog::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QProgressDialog::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
