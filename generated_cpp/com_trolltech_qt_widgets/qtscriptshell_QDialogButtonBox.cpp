...
void QtScriptShell_QDialogButtonBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QDialogButtonBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
