...
void QtScriptShell_QLineEdit::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QLineEdit::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
