...
void QtScriptShell_QMenuBar::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QMenuBar::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
