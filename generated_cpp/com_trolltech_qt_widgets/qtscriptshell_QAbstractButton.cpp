...
void QtScriptShell_QAbstractButton::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractButton::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
