...
void QtScriptShell_QPushButton::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QPushButton::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
