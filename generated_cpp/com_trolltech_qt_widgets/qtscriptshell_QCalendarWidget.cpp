...
void QtScriptShell_QCalendarWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QCalendarWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
