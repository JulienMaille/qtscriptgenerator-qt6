...
void QtScriptShell_QGroupBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QGroupBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
