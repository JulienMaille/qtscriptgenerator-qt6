...
void QtScriptShell_QColorDialog::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QColorDialog::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
