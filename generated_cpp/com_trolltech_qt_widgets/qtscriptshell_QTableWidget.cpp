...
void QtScriptShell_QTableWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTableWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
...
QStyleOptionViewItem  QtScriptShell_QTableWidget::viewOptions() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QTableWidget::initViewItemOption(&_q_result);
        return _q_result;
    } else {
