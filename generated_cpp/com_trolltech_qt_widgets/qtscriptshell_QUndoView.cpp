...
void QtScriptShell_QUndoView::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QUndoView::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
...
QStyleOptionViewItem  QtScriptShell_QUndoView::viewOptions() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QUndoView::initViewItemOption(&_q_result);
        return _q_result;
    } else {
