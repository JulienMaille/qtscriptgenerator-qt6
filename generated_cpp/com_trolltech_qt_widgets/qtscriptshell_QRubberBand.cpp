...
void QtScriptShell_QRubberBand::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QRubberBand::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
