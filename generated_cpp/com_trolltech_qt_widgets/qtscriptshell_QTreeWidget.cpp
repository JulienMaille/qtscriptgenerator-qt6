...
void QtScriptShell_QTreeWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTreeWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
...
QStyleOptionViewItem  QtScriptShell_QTreeWidget::viewOptions() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QTreeWidget::initViewItemOption(&_q_result);
        return _q_result;
    } else {
