...
void QtScriptShell_QComboBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QComboBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
