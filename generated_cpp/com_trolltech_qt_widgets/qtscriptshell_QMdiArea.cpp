...
void QtScriptShell_QMdiArea::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QMdiArea::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
