...
void QtScriptShell_QStackedWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QStackedWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
