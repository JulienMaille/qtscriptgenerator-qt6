...
void QtScriptShell_QTabWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTabWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
