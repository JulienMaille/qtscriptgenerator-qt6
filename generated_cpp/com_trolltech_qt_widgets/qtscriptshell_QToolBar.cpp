...
void QtScriptShell_QToolBar::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QToolBar::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
