...
void QtScriptShell_QDoubleSpinBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QDoubleSpinBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
