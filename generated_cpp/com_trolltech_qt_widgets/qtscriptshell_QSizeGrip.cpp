...
void QtScriptShell_QSizeGrip::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QSizeGrip::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
