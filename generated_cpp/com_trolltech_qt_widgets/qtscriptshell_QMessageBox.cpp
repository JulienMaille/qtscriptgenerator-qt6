...
void QtScriptShell_QMessageBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QMessageBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
