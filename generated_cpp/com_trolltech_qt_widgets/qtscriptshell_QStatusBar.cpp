...
void QtScriptShell_QStatusBar::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QStatusBar::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
