...
void QtScriptShell_QRadioButton::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QRadioButton::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
