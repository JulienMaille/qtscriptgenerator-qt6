...
void QtScriptShell_QAbstractScrollArea::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractScrollArea::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
