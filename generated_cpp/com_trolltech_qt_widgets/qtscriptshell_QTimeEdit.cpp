...
void QtScriptShell_QTimeEdit::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTimeEdit::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
