...
void QtScriptShell_QFocusFrame::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QFocusFrame::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
