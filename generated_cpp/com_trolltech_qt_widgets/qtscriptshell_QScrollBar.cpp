...
void QtScriptShell_QScrollBar::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QScrollBar::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
