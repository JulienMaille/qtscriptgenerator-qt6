...
{
public:
    QtScriptShell_QProgressDialog(QWidget*  parent = 0, Qt::WindowFlags  flags = {});
    QtScriptShell_QProgressDialog(const QString&  labelText, const QString&  cancelButtonText, int  minimum, int  maximum, QWidget*  parent = 0, Qt::WindowFlags  flags = {});
