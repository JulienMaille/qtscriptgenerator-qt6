...
void QtScriptShell_QInputDialog::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QInputDialog::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
