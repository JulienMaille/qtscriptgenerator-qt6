...
void QtScriptShell_QMainWindow::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QMainWindow::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
