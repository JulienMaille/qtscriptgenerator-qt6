...
void QtScriptShell_QScrollArea::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QScrollArea::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
