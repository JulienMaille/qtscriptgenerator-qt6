...
void QtScriptShell_QTableView::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTableView::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
...
QStyleOptionViewItem  QtScriptShell_QTableView::viewOptions() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QTableView::initViewItemOption(&_q_result);
        return _q_result;
    } else {
