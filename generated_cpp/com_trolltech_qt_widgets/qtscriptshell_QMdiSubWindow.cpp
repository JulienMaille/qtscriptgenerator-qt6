...
void QtScriptShell_QMdiSubWindow::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QMdiSubWindow::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
