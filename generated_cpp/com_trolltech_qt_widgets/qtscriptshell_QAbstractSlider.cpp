...
void QtScriptShell_QAbstractSlider::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractSlider::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
