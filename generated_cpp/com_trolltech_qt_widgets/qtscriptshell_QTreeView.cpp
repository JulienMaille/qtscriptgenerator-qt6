...
void QtScriptShell_QTreeView::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QTreeView::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
...
QStyleOptionViewItem  QtScriptShell_QTreeView::viewOptions() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QTreeView::initViewItemOption(&_q_result);
        return _q_result;
    } else {
