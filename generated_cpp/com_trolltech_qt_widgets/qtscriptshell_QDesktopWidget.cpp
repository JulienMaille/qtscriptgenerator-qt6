...
void QtScriptShell_QDesktopWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QDesktopWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
