...
void QtScriptShell_QSplitter::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitter::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
