...
void QtScriptShell_QAbstractSpinBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractSpinBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
