...
void QtScriptShell_QDockWidget::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QDockWidget::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
