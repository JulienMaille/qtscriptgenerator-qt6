...
void QtScriptShell_QWizardPage::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QWizardPage::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
