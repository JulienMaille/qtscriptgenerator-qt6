...
void QtScriptShell_QCheckBox::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QCheckBox::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
