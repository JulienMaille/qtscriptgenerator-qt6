...
void QtScriptShell_QAbstractItemView::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractItemView::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
...
QStyleOptionViewItem  QtScriptShell_QAbstractItemView::viewOptions() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QAbstractItemView::initViewItemOption(&_q_result);
        return _q_result;
    } else {
