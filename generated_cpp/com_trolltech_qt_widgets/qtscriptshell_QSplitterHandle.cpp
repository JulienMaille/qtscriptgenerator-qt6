...
void QtScriptShell_QSplitterHandle::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitterHandle::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
