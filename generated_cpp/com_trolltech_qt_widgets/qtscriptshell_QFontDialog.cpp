...
void QtScriptShell_QFontDialog::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QFontDialog::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
