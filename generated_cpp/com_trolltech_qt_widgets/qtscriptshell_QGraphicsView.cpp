...
void QtScriptShell_QGraphicsView::enterEvent(QEnterEvent*  arg__1)
{
...
bool  QtScriptShell_QGraphicsView::nativeEvent(const QByteArray&  eventType, void*  message, qintptr*  result)
{
